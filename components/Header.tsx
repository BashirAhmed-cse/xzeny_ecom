        ...
        >
          ...
          <motion.div variants={iconVariants} whileHover="hover" className="relative">
            ...
            >
              ...
              {cartCount > 0 && (
                <motion.span
                  className="absolute -top-2 -right-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center shadow-[0_0_10px_rgba(245,158,11,0.6)]"
                  initial={{ scale: 0 }}
