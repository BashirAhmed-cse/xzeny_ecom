...
const ShoeCard: React.FC<ShoeCardProps> = ({
  ...
  const imageVariants = {
    scrollDownEnter: {
      ...
      transition: { duration: ANIMATION_DURATION_S, ease: [0.25, 0.8, 0.25, 1] },
    },
    scrollUpExit: {
  ...
  const tagVariants = {
    ...
    visible: (config: { delay: number; finalX: number; finalY: number; rotation: number }) => ({
      ...
      transition: { duration: 0.8, delay: config.delay, type: "spring", stiffness: 100, damping: 15 },
    }),
    hover: {
      scale: 1.15,
    ...
    >
      ...
      <div className="relative w-full max-w-6xl">
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center" role="list">
